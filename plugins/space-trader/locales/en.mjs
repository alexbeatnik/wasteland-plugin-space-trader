...
{language}`,
  ...
  'move.quit.label': 'CLOSE',
  'move.quit.hint': 'put the game away — the run is kept',
  'move.quit.hintOver': 'put the game away',
  ...
  'fight.move.surrender.label': 'SURRENDER',
  ...
  'ui.quitIsYours': 'Closing the game is the CLOSE button, not mine to press.',
